<%@ page import="com.xypowernode.crm.settings.entity.DicValue" %>
<%@ page import="com.xypowernode.crm.workbench.entity.Tran" %>
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/transaction/getUserListAndTran.do?id=${t.id}';"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
