				...
				if (confirm("确实删除所选择的记录吗？")){
					...
					$.ajax({
						...
						success:function (data) {
							if (data.success){
								tranList(1,$("#tranPage").bs_pagination('getOption', 'rowsPerPage'));
							}else {
								alert("删除交易列表失败");
							}
						}
...
<%--							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/transaction/detail.do?id=fe1841b3320d40228fa41e9d232d882a';">交易123</a></td>--%>
<%--							<td>动力节点</td>--%>
<%--							<td>谈判/复审</td>--%>
<%--							<td>新业务</td>--%>
<%--							<td>zhangsan</td>--%>
